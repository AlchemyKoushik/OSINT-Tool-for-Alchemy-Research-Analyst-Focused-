...
def build_recent_company_developments_payload(
    *,
    ...
    return (
        ...
        "- Come from company-specific evidence rather than a generic market roundup or competitor list\n"
        "- Describe one company action only and never merge updates from multiple companies into one item\n\n"
        "---\n\n"
        "## Output Requirements\n\n"
        "### Maximum Results\n"
        ...
        "- No top-companies pages, competitor roundups, or multi-company market lists are used as standalone development sources\n\n"
