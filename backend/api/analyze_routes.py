...
from api.analyze import analyze_topic, get_ies_catalog, get_locations, get_research_job_status, ies_report, research_topic

router = APIRouter(prefix="/api")
router.add_api_route("/locations", get_locations, methods=["GET"])
router.add_api_route("/ies-catalog", get_ies_catalog, methods=["GET"])
router.add_api_route("/ies-report", ies_report, methods=["POST"])
